    ...
    <div class="container mx-auto px-4 pt-16">
        <div class="popular-movies">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="{{ asset('/img/joker.jpg') }}" alt="joker" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="{{ asset('/img/sonic.jpg') }}" alt="sonic" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                ...
                <div class="mt-8">
                    <a href="#">
                        <img src="{{ asset('/img/frozen2.jpg') }}" alt="frozen" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
