...
@section('content')
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            ...
            <img src="{{ $tvshow['poster_path'] }}" alt="tvshow image" class="w-64 md:w-96">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span class="mx-2">|</span>
                    <span><i class="fas fa-clock"></i> {{ $tvshow['episode_run_time'] }}</span>
                </div>
                ...
                <div class="mt-12">
                    <div class="flex mt-4">
                        @forelse ($tvshow['created_by'] as $crew)
                            <div class="mr-8">
                                <div>{{ $crew['name'] }}</div>
    ...
    <div class="tvshow-cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                @forelse ($tvshow['head_cast'] as $actor)
                    <div class="mt-8">
            ...
            @if (count($tvshow['secondary_cast']) > 0)
                <div x-data="{ isOpen: false }">
                    <div class="mt-10">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-4" x-show="isOpen" x-cloak>
                        @foreach ($tvshow['secondary_cast'] as $actor)
    ...
    <div class="tvshow-seasons border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold">
                Saisons  
            </h2>  
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-7 gap-5">
                @forelse ($tvshow['seasons'] as $season)
                    <div class="mt-8">
                        <a href="#">
                            <img src="{{ $season['poster_path'] }}" alt="season poster" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                ...
                @forelse ($tvshow['images'] as $image)                    
                    <div class="mt-8">
                        <a 
                            ...
                            "
                        >
                            <img src="{{ $image['file_path'] }}" alt="tvshow images" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                    </div>     
                @empty 
                   <p>Aucune donnée</p>                                
            ...
            >
                <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
                    <div class="bg-gray-900 rounded"  @click.away="isOpen = false">
                        ...
                        <div class="modal-body px-8 py-8">
                            <img :src="image" alt="tvshow image">
                        </div>
                    </div>
                </div>
            </div>
